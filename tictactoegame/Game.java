 ...
 * @author Brian Atwell
 * @date 1/31/2016
 * Modified Date: 3/26/17 by Emily Day
 * 
...
public class Game {
	...
	public int takeTurn(Markers marker, int pos)
	{
		//while(gamestate != GameStates.Play) {
			//Do nothing, wait for game state to return to 'play'
		//}
	...
	{
		//while(gamestate != GameStates.Play) {
			//Do nothing, wait for game to return to 'play'
		//}
		if(!isAlive)
		{
			return -6;
	...
	protected void onTurnEnd(Markers marker, int pos)
	{
		...
		while(iter.hasNext())
		{
			...
			StatusFeed.updateStatus("On LISTENER turn end\n");
		}
	}
	...
	/* public boolean setState(GameStates state) {

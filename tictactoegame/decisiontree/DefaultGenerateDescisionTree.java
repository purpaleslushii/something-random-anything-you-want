package edu.sru.nao.version2gui.tictactoegame.decisiontree;
...
import edu.sru.nao.version2gui.tictactoegame.GameChecker;
import edu.sru.nao.version2gui.tictactoegame.Markers;
import edu.sru.nao.version2gui.tictactoegame.WinStatus;
import edu.sru.nao.version2gui.tictactoegame.WinnerRowID;
import edu.sru.nao.version2gui.tictactoegame.decisiontree.narytree.NTLevelorderIterator;
import edu.sru.nao.version2gui.tictactoegame.decisiontree.narytree.NTTopToBottomBranchIterator;
import edu.sru.nao.version2gui.tictactoegame.decisiontree.narytree.NaryTree;
...
public class DefaultGenerateDescisionTree {
	...
	private static void testWinPropagation()
	{
		...
		Object[] dataAry;
		TTTGameData sigData;
		NTTopToBottomBranchIterator iter = locRoot.topToBottomBranchIterator();
	...
	public static void levelOrderTest()
	{
		...
		TTTGameData sigData;
		NTLevelorderIterator iter = locRoot.levelorderIterator();
